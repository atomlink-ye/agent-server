...
export const compatibilitySurfaceRecords: readonly CompatibilitySurfaceRecord[] = [
  {
    ...
    reason: 'Historical invokable records require a read-only projection during import.',
    removeWhen: 'All persisted invokable records use the managed AgentDefinition shape.',
  },
  {
    ...
    owner: 'domain/invokables',
    reason: 'Historical invokable snapshots are decoded through the legacy projection.',
    removeWhen: 'All persisted invokable records use the managed AgentDefinition shape.',
  },
  {
    ...
    owner: 'domain/invokables',
    reason: 'Invokable records are constructed through the legacy projection boundary.',
    removeWhen: 'All callers construct managed AgentDefinition records directly.',
  },
  {
    ...
    owner: 'domain/invokables',
    reason: 'Invokable snapshots are decoded through the legacy projection boundary.',
    removeWhen: 'All persisted invokable records use the managed AgentDefinition shape.',
  },
  {
    ...
    reason: 'Existing agent-home rows remain readable during the datastore cutover.',
  ...
  },
  {
    ...
    reason: 'The PostgreSQL runtime workspace repository exposes the established workspace result type.',
  ...
  },
  {
    ...
    reason: 'The PostgreSQL session repository exposes the established workspace result type.',
