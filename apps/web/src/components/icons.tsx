...
export const IWhisper = (p: IconProps) => (
  <svg {...base} {...p}>
    <path d="M3 12c0-4 4-8 9-8s9 4 9 8-4 8-9 8a10 10 0 01-3-.5L3 21l1.5-5A8 8 0 013 12z" />
...
export const IAgent = (p: IconProps) => (
  <svg {...base} {...p}>
    ...
    <path d="M4.5 20c0-3.3 2.5-6 5.5-6s5.5 2.7 5.5 6" />
    <path d="M18 4l.7 1.8 1.8.7-1.8.7L18 9l-.7-1.8-1.8-.7 1.8-.7L18 4z" />
  </svg>
);
...
export const IMemory = (p: IconProps) => (
  <svg {...base} {...p}>
    <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h4M16 3h6v6" />
...
export const IObserve = (p: IconProps) => (
  <svg {...base} {...p}>
    ...
    <path d="M4 20h16M7 20v-3M12 20v-2M17 20v-3" />
  </svg>
);
...
export const IClip = (p: IconProps) => (
  <svg {...base} {...p}>
    <path d="M21.4 11l-9.6 9.6a5.5 5.5 0 11-7.7-7.7l9.6-9.6a3.7 3.7 0 015.2 5.2l-9.6 9.6a1.8 1.8 0 11-2.6-2.6l8.8-8.8" />
  </svg>
);
...
export const IPin = (p: IconProps) => (
  <svg {...base} {...p}>
    <path d="M12 17v5M9 7v5l-3 4h12l-3-4V7M9 7h6M9 7l-2-3h10l-2 3" />
  </svg>
);
...
export const IFile = (p: IconProps) => (
  <svg {...base} {...p}>
    ...
    <path d="M14 2v6h6M14 13H8M14 17H8" />
  </svg>
);
...
export const IShip = (p: IconProps) => (
  <svg {...base} {...p}>
    <path d="M12 3v13M8 7h8M5 21h14" />
    <path d="M4 13l8 5 8-5M6 10l-2 3M18 10l2 3" />
  </svg>
);
