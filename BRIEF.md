...
## Your lane: B — Work page information architecture

The Work page is the most important surface in this product and the user has said its text sizing
and information density still feel wrong, especially in Chinese.

Work through it as a user, not as a developer reading components: what is a person trying to
accomplish when they open Work, what must they see first, what must they act on, what is merely
reference. Then judge whether our information carrying matches that, and change it where it does not.
Use designer and oracle subagents for the judgement calls, explorer/librarian for the legwork.
Measure at 1440 in both locales and record before/after numbers.
