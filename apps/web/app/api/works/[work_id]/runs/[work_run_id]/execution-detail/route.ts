...
import { ProductExecutionDetailResponseSchema } from '@atomlink-ye/agent-server/product-contract';
...
export async function GET(
  ...
  if (!UUID.test(workId) || !UUID.test(workRunId) || !attemptId || !UUID.test(attemptId))
