...
export function RunTrace({ trace }: { readonly trace: Trace }) {
  ...
  return <section className="run-trace" aria-labelledby="run-trace-heading">
    <header className="run-trace__header"><div><p className="run-trace__eyebrow">Historical Run Trace</p><h2 id="run-trace-heading">Recorded activity</h2></div><span className="run-trace__historical">Historical</span></header>
    <p className="run-trace__subhead">Captured MCP dispatch and confirmation activity</p>
    ...
    {view === 'timeline' ? <div className="run-trace__body"><div className="run-trace__canvas"><div className="run-trace__timeline" data-testid="trace-timeline"><div className="run-trace__axis"><span>Earlier</span><span>Later</span></div>{trace.actors.map((actor) => {
