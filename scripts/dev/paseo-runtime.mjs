...
const forwardedEnvironmentNames = [
  ...
  // AWS Bedrock transport for Claude Code. The daemon environment is the
  // isolated safe set plus the names listed here, so an unlisted variable
  // silently leaves the daemon on the Anthropic API path.
  // See src/shared/claude-code-transport.ts.
