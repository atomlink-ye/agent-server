...
import type {
  ...
  ResourceKind,
} from './resolved-resource-manifest.js';
...
export interface ResolvedWorkDefinition {
  ...
  /** Fingerprint of the author-visible immutable definition/version input. */
  readonly sourceFingerprint: string;
  /** Fingerprint after all referenced immutable resources are resolved. */
...
export const isManifestResourceKind = (value: string): value is ResourceKind =>
  (
    [
      'definition',
      'agent',
  ...
  ).includes(value as ResourceKind);
